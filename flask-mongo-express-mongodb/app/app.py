...
def home():
    ...
    if(len(posts)==0):
        ...
        db.posts.insert_one({"title": "Mayday", "author": "Karen Harrington", "createdAt": datetime.now()})
        db.posts.insert_one({"title": "The Bad Book", "author": "Andy Griffiths", "createdAt": datetime.now()})
        db.posts.insert_one({"title": "Danger!", "author": "Laura Buller", "createdAt": datetime.now()})
